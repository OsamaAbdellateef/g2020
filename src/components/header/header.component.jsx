            ...
            <Container>
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    ...
                    <Nav className="mr-auto">
                        ...
                        {currentUser ? (currentUser.signedAs == "worker" ? (<Nav.Link as={Link} className="mr-2" to="/accepted-requests" href="/accepted-requests">الطلبات المقبولة ({accReq.length})</Nav.Link>) : (null)) : (null)}
